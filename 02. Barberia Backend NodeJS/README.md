# Barberia backend MinTIC
Arquitectura backend del proyecto realizado en el cuarto ciclo de la iniciativa MinTIC.

El proyecto expone una API REST realizada con node.js y express.js.
